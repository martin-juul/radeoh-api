...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-json-schema-field', __webpack_require__(3));
  Vue.component('detail-json-schema-field', __webpack_require__(6));
  Vue.component('form-json-schema-field', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c(
      ...
      [
        _vm._t("value", [
          _vm.field.value !== "null"
            ? _c("div", { staticClass: "text-90" }, [
                _vm.field.value && _vm.isObject(_vm.field.value)
                  ? _c(
                      "ul",
                      { class: _vm.field.options.listClass },
                      _vm._l(_vm.field.value, function(value, key) {
                        return _c("li", { staticClass: "pb-2" }, [
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fieldHasError: function fieldHasError(key) {
...
var render = function() {
  ...
  return _c("field-wrapper", [
    ...
    _c(
      "div",
      { staticClass: "w-full h-full px-8 py-6" },
      [
    ...
    _c(
      "div",
      { staticClass: "w-4/5 h-full px-8 py-6" },
      _vm._l(_vm.properties, function(property, key) {
        return _c("div", { staticClass: "flex border-b border-40" }, [
          _c(
            "div",
            { staticClass: "w-1/3 py-6" },
            [
              property.description
                ? [
                    _c(
                      "label",
                      {
                        staticClass: "inline-block text-80 h-9",
                        attrs: { for: key }
                      },
                      [_vm._v(_vm._s(property.description))]
                    ),
                    _vm._v(" "),
                    _c("help-text", [_vm._v(_vm._s(key))])
                  ]
                : [
                    _c(
                      "label",
          ...
          _vm._v(" "),
          _c("div", { staticClass: "w-1/2 py-6" }, [
            _c("input", {
              staticClass: "w-full form-control form-input form-input-bordered",
              class: _vm.fieldHasError(key) ? "border-danger" : "",
              attrs: { id: key, type: "text" },
              domProps: { value: _vm.getValue(key) },
              on: {
                input: function(event) {
                  return _vm.setValue(key, event.target.value)
                }
              }
            }),
            _vm._v(" "),
            _vm.fieldHasError(key)
              ? _c("p", { staticClass: "my-2 text-danger" }, [
                  _vm._v(
                    "\n                    " +
                      _vm._s(_vm.getError(key)) +
                      "\n                "
                  )
                ])
              : _vm._e()
